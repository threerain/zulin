					...
					$proarr3=implode(',',$proarr3);
						...
						//内圈查询
								...
								if($keyword_estates !=null){
										if($proarr1){
												$condition.= " and  property_id in ($proarr1) ";
										}else{
												$condition.= " and  property_id in ('') ";
										}
								}
								if($keyword_building !=null){
										if($proarr2){
												$condition.= " and  property_id in ($proarr2) ";
										}else{
												$condition.= " and  property_id in ('') ";
										}
								}
								if($keyword_room_number !=null){
										if($proarr3){
												$condition.= " and  property_id in ($proarr3) ";
										}else{
												$condition.= " and  property_id in ('') ";
										}
								}
               	...
               	$id = Yii::app()->request->getParam('id');
					...
					public function actiongetorder() {
						...
						try{
								...
								if($model->repair_type==8 || $model->repair_type==7) {
									...
									if($model->repair_type==7) {
										$list->decoration_type = 3;
									}
									if(!$list->save()) {
