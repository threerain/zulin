...
#youshititle{height:40px;margin-top:-80px;line-height:40px;position:absolute;font-size:30px;color:#fff;letter-spacing: 1px;}
...
#username,#password{border-left-width:0px;border-right-width:0px;border-top-width:0px;border-bottom:1px solid #aaa;}
      ...
      <form class="form-vertical login-form" method="POST" action="/phone/login" id="loginpage" name="Form1">
      <h3 id="youshititle">幼狮空间管理平台</h3>
