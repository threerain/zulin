      ...
      <div class="span12">
        ...
        <div class="portlet box light-grey">
          <div class="portlet-title">
            ...
            <div class="caption"><i class="icon-globe"></i>商圈列表</div>
            <div class="tools">
<!--               <a href="javascript:;" class="collapse"></a>
          ...
          <div class="portlet-body">
            <div id="sample_1_wrapper" class="dataTables_wrapper form-inline" role="grid">
              <div class="row-fluid">
                <div class="span6">
                  <form action="/admin/area/index" style="margin-top:20px;margin-bottom:20px;padding-left:30px;" >
              ...
              <table class="table table-striped table-bordered table-hover" id="sample"><!-- ID sample_1目前没用,js中控制显示效果 -->
                <thead>
                  <tr>
                    ...
                    <th class="hidden-480">行政区</th>
                    <th class="hidden-480">商圈名</th>
                  ...
                  if($list){
                    ...
                    foreach($list as $model){
                      ...
                      <tr class="odd gradeX">
                        ...
                        <td class="hidden-480"><?php $item=BaseDistrict::model()->find("id='$model->district_id'"); echo $item?$item->name:""; ?></td>
                        ...
                        <!-- <td class="hidden-480"><?php //echo $model->deleted; ?></td> -->
                        ...
                        <td>
                          <div class="btn-operation">
                            ...
                            <?php if(AdminPositionModul::has_modul("002_02")) {?>
                              <a href="/admin/area/edit/id/<?php echo $model->id;?>">编辑</a>
                            <?php }?>
                            <?php if(AdminpositionModul::has_modul("002_03")) {?>
                              <a href="" address="/admin/area/delete/id/<?php echo $model->id;?>" style="display:block" class="delete" data-toggle="modal" data-target="#about-modal">删除</a>
                            <?php }?>
                            </ul>
                          </div> 
