      ...
      <div class="span12">
        ...
        <div class="portlet box light-grey">
          <div class="portlet-title">
            ...
            <div class="caption"><i class="icon-globe"></i>组团管理列表</div>
            <div class="tools">
<!--               <a href="javascript:;" class="collapse"></a>
          ...
          <div class="portlet-body">
            <div id="sample_1_wrapper" class="dataTables_wrapper form-inline" role="grid">
              <div class="row-fluid">
                <div class="span6">
                  <form action="/admin/estategroup/index" style="margin-top:20px;margin-bottom:20px;padding-left:30px;" >
                ...
                <div class="span6" style="margin-top:40px;">
                  <?php if(AdminPositionModul::has_modul("008_04")) {?>
                    <div class="btn-group pull-right">
                      <a href="/admin/estategroup/create">
                  ...
                  if($list){
                    ...
                    foreach($list as $model){
                      ...
                      <tr>
                        ...
                        <td><?php $item=BaseArea::model()->find("id='$model->area_id'"); echo $item?$item->name:""; ?></td>
                        ...
                        <td>
                          <div class="btn-operation">
                            ...
                            <ul class="dropdown-menu" style="left: -38px;width:140px !important;">
                              <?php if(AdminPositionModul::has_modul("008_02")) {?>
                                <a href="/admin/estategroup/edit/id/<?php echo $model->id;?>">编辑</a>
                              <?php }?>
                              <?php if(AdminPositionModul::has_modul("008_03")) {?>
                                <a href="" address="/admin/estategroup/delete/id/<?php echo $model->id;?>" style="display:block" class="delete" data-toggle="modal" data-target="#about-modal">删除</a>
                              <?php }?>
                            </ul>
                          </div>  
                        </td>
