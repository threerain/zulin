...
<style>
	.dataTables_filter{padding-left:100px;margin-top:25px!important;font-size:15px;}
	div>b{font-size:18px;margin-left:30px;}

	.dataTables_filter{margin-top:30px!important;}
</style>
...
<!--
                     ...
                     <div class="dataTables_filter" style="margin-bottom:10px">
                      <span class="test line21" style="margin-left:95px"><b>制单人:</b>&nbsp;
												<?php
											 ...
											 <?php if($model->repair_user_type==1){
												 ?>
												 <div class="dataTables_filter" style="margin-bottom:10px">
														<span class="test line21" style="margin-left:80px"><b>报修租户:</b>&nbsp;
																<?php
											 ...
											 <?php }else{?>
												 <div class="dataTables_filter" style="margin-bottom:10px">
													<span class="test line21" style="margin-left:80px"><b>报修部门:</b>&nbsp;
														 <?php
													...
													<div class="dataTables_filter" style="margin-bottom:10px">
													 <span class="test line21" style="margin-left:80px"><b>报修人员:</b>&nbsp;
															 <?php
												...
												<?php } ?>
                       <div class="dataTables_filter" style="margin-bottom:10px">
                      <span class="test line21" style="margin-left:110px"><b>电话:</b>&nbsp;
													<?php
															echo $model->phone;
													?>
                      </span>
                      ...
                      <div class="dataTables_filter" style="margin-bottom:10px">
                      <span class="test line21" style="margin-left:80px"><b>报修品牌:</b>&nbsp;
													<?php
                       ...
                       <div class="dataTables_filter" style="margin-bottom:10px">
                      <span class="test line21" style="margin-left:80px"><b>报修系列:</b>&nbsp;
													<?php
															$data=CmsProperty::model()->find("id='$model->property_id'");
                       ...
                       <div class="dataTables_filter" style="margin-bottom:10px">
                      <span class="test line21" style="margin-left:95px"><b>编号:</b>&nbsp;
												<?php
											 ...
											 <div class="dataTables_filter" style="margin-bottom:10px">
											<span class="test line21" style="margin-left:110px"><b>类型:</b>&nbsp;
												<?php
  														if($model->repair_type==1){
  																			echo '收房隐患';
  														}else if($model->repair_type==2){
  																			echo '交房隐患';
  														}else if($model->repair_type==3){
  																			echo '咨询开发票';
  														}else if($model->repair_type==4){
  																			echo '注册迁址';
  														}else if($model->repair_type==5){
  																			echo '投诉';
  														}else if($model->repair_type==6){
  																			echo '维修';
  														}else if($model->repair_type==7){
  															       echo '租户意向装修';
  														}else if($model->repair_type==8) {
                                        echo '装修二次升级';
                              }
  											?>
											</span>
                         ...
                         <div class="dataTables_filter" style="margin-bottom:10px">
                      <span class="test line21" style="margin-left:80px"><b>报修隐患:</b>&nbsp;
													<?php
																echo $model->hidden;
													?>
                      </span>
                        ...
                        <div class="dataTables_filter" style="margin-bottom:10px">
                      <span class="test line21" style="margin-left:80px"><b>隐患详情:</b>&nbsp;
													<?php
                      ...
                      <span class="test line21"><b>维修方:</b>
											//	<?php
											 ...
											 <?php if($model->repair_type==1 || $model->repair_type==2){?>
																								 ...
																								 <div class="dataTables_filter" style="margin-bottom:10px">
																							 <span class="test line21" style="margin-left:-10px"><b>车主约定维修结束日期:</b>&nbsp;
																								 <?php
																								 				if($model->hope_end_time) {
                       ...
                       <div class="dataTables_filter" style="margin-bottom:10px">
                      <span class="test line21" style="margin-left:65px"><b>费用承担方:</b>&nbsp;
												<?php
		                        ...
		                        <div class="dataTables_filter" style="margin-bottom:10px">
		                       <span class="test line21" style="margin-left:95px"><b>维修方:</b>&nbsp;
		 												<?php
		 														 if($model->service_type ==1){
		 															 			echo '车主';
		 														 }else if($model->service_type ==2){
                           ...
                           <div class="dataTables_filter" style="margin-bottom:10px">
											         <span class="test line21" style="margin-left:80px"><b>进展状态:</b>&nbsp;
											 								<?php
                         ...
                         <div class="dataTables_filter" style="margin-bottom:10px">
                      <span class="test line21" style="margin-left:80px">
                       <b>隐患图片:</b>&nbsp;
                      </span>
                      ...
                      <span class="test line21" style="margin-left:600px;">
