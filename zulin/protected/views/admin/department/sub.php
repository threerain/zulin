                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>子部门-新增</div>
...
<!-- 
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form action="/admin/department/subsave" id="form_sample_3"  method="post"  class="form-horizontal js-submit">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input style="border:1px solid #aaa" name="name" type="text" class="span6 m-wrap"/>
                                        </div>
                                    </div>                  
