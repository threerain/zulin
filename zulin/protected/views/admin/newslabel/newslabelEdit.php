...
<!-- 
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form action="/admin/newslabel/editsave" id="form_sample_3"  method="post"  class="form-horizontal js-submit">
...
<!--                                     <div class="control-group">
                                    ...
                                    <!-- <div class="control-group">
                                        <label class="control-label">账号<span class="required">*</span></label>
                                        <div class="controls">
                                            <?php //echo $model==null?"":$model->account;?>
                                        </div>
                                    </div> -->
                                   <!--  <div class="control-group">
										<label class="control-label">品牌ID</label>
										<div class="controls">   
											<input type="estate_id" class="span6" disabled="" placeholder="<?php //echo $model==null?"":$model->estate_id;?>" class="m-wrap medium">
										</div>
									</div> -->
                                      <div class="control-group">
                                        <label class="control-label">品牌ID</label>
                                        <div class="controls">
                                            <input name="estate_id" type="text" class="span6 m-wrap" value="<?php echo $model==null?"":$model->estate_id;?>"/>
                                        </div>
                                    </div>
                                     <div class="control-group">
                                        <label class="control-label">系列ID</label>
                                        <div class="controls">
                                            <input name="buding_id" type="text" class="span6 m-wrap" value="<?php echo $model==null?"":$model->buding_id;?>"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">编号<span class="required">*</span></label>
                                        <div class="controls">
                                            <input name="house_no" type="text" class="span6 m-wrap" value="<?php echo $model==null?"":$model->house_no;?>"/>
                                        </div>
                                    </div>
