...
<!--
                            ...
                            <div class="portlet-body form">
                                ...
                                <div  class="form-horizontal js-submit">
                                    ...
                                    <!--内容开始-->
                     <div class="dataTables_filter" style="margin-bottom:10px;margin-left:115px">
                      <span class="test line21"><b>制单人:</b>
											 ...
											 <?php if($model->repair_user_type==1){
												 ?>
												 <div class="dataTables_filter" style="margin-bottom:10px;margin-left:100px">
											 ...
											 <?php }else{?>
												...
												<?php } ?>
                       <div class="dataTables_filter" style="margin-bottom:10px;margin-left:130px">
                      ...
                      <span class="test line21"><b>报修系列:</b>
                       ...
                       <div class="dataTables_filter" style="margin-bottom:10px;margin-left:110px">
                      ...
                      <span class="test line21"><b>维修方:</b>
											 ...
											 <?php if($model->repair_type==1 || $model->repair_type==2){?>
																								 ...
																								 <div class="dataTables_filter" style="margin-bottom:10px;margin-left:20px">
                      ...
                      <span class="test line21">
						...
						预览</button>
										 ...
										 <?php  if( $list !=null && $model->evolve_type != 1 && $model->repair_type !=8) {?>
											 <div class="dataTables_filter" style="margin-bottom:10px;">
										 <span class="test line21"><h3><b>工程基本信息:</b></h3>

										 </span>
									 </div>
									 <div class="dataTables_filter" style="margin-bottom:10px;margin-left:90px">
										 <span class="test line21"><b>工程维修人:</b>
												 <?php
													 echo $list?$list->name:'';
												 ?>
										 </span>
									 ...
									 <div class="dataTables_filter" style="margin-bottom:10px;margin-left:100px">
										 <span class="test line21"><b>工程电话:</b>
												 <?php
													 echo $list?$list->phone:'';
												 ?>
										 </span>
									 </div>
									 <div class="dataTables_filter" style="margin-bottom:10px;margin-left:75px">
										 <span class="test line21"><b>工程维修隶属:</b>
												 <?php
													 echo $list?$list->subjection:'';
												 ?>
										 </span>
									 </div>
									 <div class="dataTables_filter" style="margin-bottom:10px;margin-left:75px">
										 <span class="test line21"><b>工程预计花费:</b>
												 <?php
													 echo $list?$list->project_cost/100:'';
												 ?>元
										 </span>
									 </div>
									 <div class="dataTables_filter" style="margin-bottom:10px;margin-left:90px">
										 <span class="test line21"><b>实际维修项:</b>
												 <?php
													 echo $list?$list->real_option:'';
												 ?>
										 </span>
									 </div>
									 <div class="dataTables_filter" style="margin-bottom:10px;margin-left:80px">
										 <span class="test line21"><b>实际维修详情:</b>
												 <?php
													 echo $list?$list->option_infor:'';
												 ?>
										 </span>
									 </div>
									 <div class="dataTables_filter" style="margin-bottom:10px;margin-left:90px">
										 <span class="test line21"><b>质量保修期:</b>
												 <?php
													 echo $list?(date("Y-m-d",$list->mass_time).'至'.date("Y-m-d",$list->mass_time1)):'';
												 ?>
										 </span>
									 </div>
									 <div class="dataTables_filter" style="margin-bottom:10px;margin-left:75px">
										 <span class="test line21"><b>开始维修日期:</b>
												 <?php
													 echo $list?date("Y-m-d",$list->start_time):'';
												 ?>
										 </span>
									 </div>
									 <div class="dataTables_filter" style="margin-bottom:10px;margin-left:60px">
										 <span class="test line21"><b>施工预估完成日:</b>
												 <?php
													 echo $list?date("Y-m-d",$list->hope_end_time):'';
												 ?>
										 </span>
									 </div>
