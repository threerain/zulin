                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>行政区-编辑</div>
...
<!-- 
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form action="/admin/district/editsave" id="form_sample_3"  method="post"  class="form-horizontal js-submit">
...
<!--                                     <div class="control-group">
                                    ...
                                    <div class="control-group"  style="margin-top:50px;">
                                        <label class="control-label" style="width:100px;margin-top:8px;margin-right:8px;">城市ID<span class="required">*</span></label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" style="width:100px;margin-top:8px;margin-right:8px;">行政区名称<span class="required">*</span></label>
                                        <div class="controls">
                                            <input name="name" type="text" maxlength="20" class="span2 m-wrap" value="<?php echo $model==null?"":$model->name;?>"/>
                                        </div>
                                    </div>
