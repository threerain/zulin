              ...
              <table class="table table-striped table-bordered table-hover" id="sample"><!-- ID sample_1目前没用,js中控制显示效果 -->
                <thead>
                  <tr>
                    ...
                    <th class="hidden-480" style="text-align:center">类型</th>
                    <th class="hidden-480" style="text-align:center">标题</th>
                    <th class="hidden-480" style="text-align:center">发布人</th>
                    <th class="hidden-480" style="text-align:center">创建时间</th>
                    ...
                    foreach($list as $user){
                      ...
                      <div class="btn-operation">
                        ...
                        <ul class="dropdown-menu" style="left: -38px;width:140px !important;">
                          <a href="/admin/notice/detail/id/<?php echo $user->id;?>">查看</a>
                          <?php if(AdminPositionModul::has_modul("401_02")){?>
                            <a href="/admin/notice/edit/id/<?php echo $user->id;?>">编辑</a>
                            <?php }?>
                          <?php if(AdminPositionModul::has_modul("401_03")) {?>

                            <a href="" address="/admin/notice/delete/id/<?php echo $user->id;?>" style="display:block" class="delete" data-toggle="modal" data-target="#about-modal">删除</a>
                          <?php }?>
                        </ul>
                      </div>
                        </td>
