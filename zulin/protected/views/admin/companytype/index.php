      ...
      <div class="span12">
        ...
        <div class="portlet box light-grey">
          <div class="portlet-title">
            ...
            <div class="caption"><i class="icon-globe"></i>公司类型-列表</div>
            <div class="tools">
<!--               <a href="javascript:;" class="collapse"></a>
          ...
          <div class="portlet-body">
            <div id="sample_1_wrapper" class="dataTables_wrapper form-inline" role="grid">
              <div class="row-fluid">
                <div class="span6">
                  <form action="/admin/companytype/index" style="margin-top:20px;margin-bottom:20px;padding-left:30px;" >
                ...
                <div class="span6" style="margin-top:40px;">
                  <div class="btn-group pull-right">
                    <?php
                      if(AdminPositionModul::has_modul("007_04"))  {?>
                    <a href="/admin/companytype/add">
                    ...
                    foreach($list as $user){
                      ...
                      <tr class="odd gradeX">
                        ...
                        <td>
                          ...
                          <?php if(AdminPositionModul::has_modul("007_02")){?>
                            <a href="/admin/companytype/edit/id/<?php echo $user->id;?>">修改</a>
                          <?php }?>
                          <?php if(AdminPositionModul::has_modul("007_03")) {?>
                              <a href="" address="/admin/companytype/delete/id/<?php echo $user->id;?>" style="display:block" class="delete" data-toggle="modal" data-target="#about-modal">删除</a>                              
                          <?php }?>
                            </ul>
                          </div> 
