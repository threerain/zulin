                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>公司类型-新增</div>
...
<!-- 
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form action="/admin/companytype/addsave" id="form_sample_2"  method="post"  class="form-horizontal js-submit">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="name" maxlength="50" type="text" class="span3 m-wrap"/>
