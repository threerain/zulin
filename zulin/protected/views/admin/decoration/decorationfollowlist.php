...
<!--               <a href="javascript:;" class="collapse"></a>
          ...
          <div class="portlet-body">
            <div id="sample_1_wrapper" class="dataTables_wrapper form-inline" role="grid">
              <div class="row-fluid" style="height:100px;margin-top:25px;">
                  <form action="/admin/decoration/DecorationFollow" >
                    <div class="dataTables_filter" style="margin-bottom:10px">
                      <input type="hidden"  value="<?php echo $keyword_decoration_id;?>" name="id" />
                      <span>
                        装修状态：
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr class="odd gradeX">
                        ...
                        <td class="hidden-480"><?php $data=AdminUser::model()->find("id='$user->responsible_people'"); echo $data?$data->nickname:""; ?></td>
                        <td class="hidden-480"><?php echo $user->money/100; ?></td>
                        <td class="hidden-480">
                          <?php if(AdminPositionModul::has_modul("802_11")) {?>
                            <a href="/admin/decoration/decorationdetail/id/<?php echo $user->id;?>">详情</a>
                          <?php }?>
                          <?php if(AdminPositionModul::has_modul("802_12")) {?>
                            <a href="/admin/decoration/decorationdelete/id/<?php echo $user->id;?>" onclick="javascript:return confirm('确实要删除吗?');">删除</a>
                          <?php }?>
                        </td>
                      </tr>
                  <?php
