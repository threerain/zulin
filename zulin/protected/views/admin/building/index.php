<style>#jqaddlink{display:none!important;}</style>
<?php
      ...
      <div class="span12">
        ...
        <div class="portlet box light-grey">
          <div class="portlet-title">
            ...
            <div class="caption"><i class="icon-globe"></i>品牌信息</div>
            <div class="tools">
<!--               <a href="javascript:;" class="collapse"></a>
          ...
          <div class="portlet-body">
            <div id="sample_1_wrapper" class="dataTables_wrapper form-inline" role="grid">
              <div class="row-fluid">
                <div class="span6">
                  <form action="/admin/building/index" style="margin-top:20px;margin-bottom:20px;padding-left:30px;" >
                      <div class="dataTables_filter" id="sample_1_filter">
                        <label style="float:left;">
                          <b>关键词: </b><input style="height:20px;border:1px solid #aaa" type="text" aria-controls="sample_1" class="m-wrap medium" placeholder="关键词" value="<?php echo $keyword;?>" name="keyword">
                        </label>
                      </div>
                      <div class="btn-group">
                ...
                <div class="span6" style="margin-top:40px;">
                  <?php if(AdminPositionModul::has_modul("006_04")) {?>
              ...
              <table class="table table-striped table-bordered table-hover" id="sample"><!-- ID sample_1目前没用,js中控制显示效果 -->
                <thead>
                  <tr>
                    ...
                    <th class="hidden-480">系列号</th>
                    <th class="hidden-480">类型</th>
                    <th class="hidden-480">汽车属性</th>
                  ...
                  if($list){
                    ...
                    foreach($list as $user){
                      ...
                      <tr>
                        ...
                        <td ><?php if($user->room_type){ $arr=CmsProperty::model()->arr(); echo $arr['room_type']["$user->room_type"]; }?></td>
                        <td><?php echo $user->type==1?"A1":""; echo $user->type==2?"A2":"";echo $user->type==3?"A3":"";?></td>
                        ...
                        <td>
                          ...
                          <?php if(AdminPositionModul::has_modul("006_02")) {?>
                            <a href="/admin/building/edit/id/<?php echo $user->id;?>">编辑</a>
                          <?php }?>
                          <?php if(AdminPositionModul::has_modul("006_03")) {?>
                              <a href="" address="/admin/building/delete/id/<?php echo $user->id;?>" style="display:block" class="delete" data-toggle="modal" data-target="#about-modal">删除</a>
                          <?php }?>
                            </ul>
                          </div>
                        </td>
