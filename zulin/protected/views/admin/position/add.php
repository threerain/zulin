                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>职务-新建</div>
...
<!-- 
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form action="/admin/position/addsave" id="form_sample_2"  method="post"  class="form-horizontal js-submit">
 ...
 <!--                                    <div class="control-group" id="zhiwei" >
                                        <label class="control-label" style="margin-top:10px;">职位<span class="required">*</span></label>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label" style="margin-top:10px;">职务名<span class="required">*</span></label>
                                        <div class="controls">
                                            <input name="name" style="height:20px;border:1px solid #aaa;" type="text" class="span6 m-wrap"/>
                                        </div>
                                    </div>
