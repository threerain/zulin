                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box green">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>管理员-新增</div>
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="/admin/admin/addsave" id="form_sample_2"  method="post"  class="form-horizontal js-submit">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="account" type="text" class="span2 m-wrap" required />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">密码<span class="required">*</span></label>
                                        <div class="controls">
                                            <input name="password" type="text" class="span2 m-wrap" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="r_password" type="text" class="span2 m-wrap" required/>
                                        </div>
                                    </div>
                                    <script>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="nickname" type="text" class="span2 m-wrap" required />
                                        </div>
                                    </div>
                                    <div class="control-group">
...
<!--                                         <div class="controls">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="input-append date form_datetime">
                                                <input type="text" id="datepicker" value="" name="birthday"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="phone" type="text" class="span2 m-wrap"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">身份证号</label>
                                        <div class="controls">
                                            <input name="id_card" type="text" class="span2 m-wrap"/>
                                        </div>
                                    </div>
                                    <!--                                     <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="bank" type="text" class="span2 m-wrap"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">银行卡号</label>
                                        <div class="controls">
                                            <input name="bank_card" type="text" class="span2 m-wrap"/>
                                        </div>
                                    </div>
                                    <!--                                     <div class="control-group">
                                        <label class="control-label">银行卡图片</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="work_no" type="text" class="span2 m-wrap"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
