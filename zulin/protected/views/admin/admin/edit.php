...
<!-- 
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form action="/admin/admin/editsave" id="form_sample_3"  method="post"  class="form-horizontal js-submit">
...
<!--                                     <div class="control-group">
                                    ...
                                    <div class="control-group" style="margin:30px 50px;">
                                       ...
                                       <div class="control-group">
                                        <label class="control-label"><b>密码&nbsp;&nbsp;</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="nickname" type="text" class="span2 m-wrap" value="<?php echo $model==null?"":$model->nickname;?>" required />
                                        </div>
                                    </div>
...
<!--                                         <div class="controls">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="input-append date form_datetime">
                                                <input type="text" id="datepicker" value="<?php echo $model==null?"":date('Y-m-d',$model->birthday)?>" name="birthday"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="id_card" value="<?php echo $model==null?"":$model->id_card?>" type="text" class="span2 m-wrap"/>
                                        </div>
                                    </div>
                                    <!--                                     <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="bank" type="text" value="<?php echo $model==null?"":$model->bank?>" class="span2 m-wrap"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">银行卡号</label>
                                        <div class="controls">
                                            <input name="bank_card" type="text" value="<?php echo $model==null?"":$model->bank_card?>" class="span2 m-wrap"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
