      ...
      <div class="span12">
        ...
        <div class="portlet box light-grey">
          <div class="portlet-title">
            ...
            <div class="caption"><i class="icon-globe"></i>品牌管理列表</div>
            <div class="tools">
<!--               <a href="javascript:;" class="collapse"></a>
          ...
          <div class="portlet-body">
            <div id="sample_1_wrapper" class="dataTables_wrapper form-inline" role="grid">
              <div class="row-fluid">
                <div class="span6">
                  <form action="/admin/estate/index" style="margin-top:20px;margin-bottom:20px;padding-left:30px;">
                      <div class="dataTables_filter" id="sample_1_filter">
                        <!-- <label style="float:left;">
                         <b> 组团:</b> <input style="height:20px;border:1px solid #aaa" type="text" aria-controls="sample_1" class="m-wrap medium"  value="<?php echo $keyword_group;?>" name="keyword_group">
                        </label> -->
                        <label style="float:left;margin-left:20px;">
                         <b> 品牌:</b> <input style="height:20px;border:1px solid #aaa" type="text" aria-controls="sample_1" class="m-wrap medium"  value="<?php echo $keyword;?>" name="keyword">
                        </label>
                      </div>
                      <div class="btn-group">
                ...
                <div class="span6" style="margin-top:40px;">
                  <?php if(AdminPositionModul::has_modul("003_04")) {?>
                    <div class="btn-group pull-right">
                      <a href="/admin/estate/create">
                  ...
                  if($list){
                    ...
                    foreach($list as $model){
                      ...
                      <tr>
                        ...
                        <td><?php echo substr($model->id, 25); ?></td>
                        <!-- <td class="hidden-480"><?php //$item=BaseArea::model()->find("id='$model->area_id'"); echo $item?$item->name:""; ?></td> -->
                        <!-- <td><?php $item=BaseEstateGroup::model()->find("id='$model->estate_group_id'"); echo $item?$item->name:""; ?></td> -->
                        <td><?php echo $model->name; ?></td>
                        <td><?php $item=AdminUser::model()->find("id='$model->creater_id'"); echo $item?$item->nickname:""; ?></td>
                        <!-- <td><?php //echo $model->deleted; ?></td> -->
                        ...
                        <td>
                          <div class="btn-operation">
                            ...
                            <ul class="dropdown-menu" style="left: -38px;width:140px !important;">
                              <?php if(AdminpositionModul::has_modul('003_02')) {?>
                                <a href="/admin/estate/edit/id/<?php echo $model->id;?>">编辑</a>
                              <?php }?>
                              <?php if(AdminPositionModul::has_modul("003_03")) {?>
                                <a href="" address="/admin/estate/delete/id/<?php echo $model->id;?>" style="display:block" class="delete" data-toggle="modal" data-target="#about-modal">删除</a>
                              <?php }?>
                            </ul>
                          </div>
                        </td>
