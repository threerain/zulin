              ...
              <div class="row-fluid">
                ...
                <div class="span6">
                  ...
                  <?php foreach ($signerlist as $key => $value): ?>
                    <a href="/admin/pluscommission/guanyong/guanyong/<?php echo $value; ?>/type/<?php echo $type?>"><?php echo $value; ?></a>
                  <?php endforeach ?>
                  <form action="/admin/pluscommission/index" style="margin:0" >
                      <div class="dataTables_filter" id="sample_1_filter">
                      <input type="hidden" name="type" value="<?php echo $type?>">
                        <label style="float:left;">
                        <span id="specialfont"> 管佣人: </span> <input type="text" aria-controls="sample_1" class="m-wrap medium " placeholder="例：张三" value="<?php echo $guanyong;?>" name="signer">
                        </label>
                      </div>
                      <div class="btn-group">
                  ...
                  总计：<?php echo $guanyong_plus/100;?>元; 面积总计：<?php echo $total_area;?>(㎡)
                </div>
              </div>
                  ...
                  if($list){
                    ...
                    foreach($list as  $value){
                      ...
                      <tr class="odd gradeX">
                        ...
                        <td class="center hidden-480"><?php echo $value['money']/100*($value['area_scale'])?></td>
