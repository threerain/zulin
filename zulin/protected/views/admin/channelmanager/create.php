                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-title">
                                ...
                                <div class="caption"><i class="icon-reorder"></i>渠道公司人员维护-新增</div>
...
<!-- 
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form action="/admin/channelmanager/createsave" id="form_create"  method="post"  class="form-horizontal js-submit">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="hidden" required name="channel_id" id="channel_id" class="span3 select2">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="phone" onblur="check_phone(this.value,this);" type="text" class="span3 m-wrap"/>
                                        </div>
                                    </div>
