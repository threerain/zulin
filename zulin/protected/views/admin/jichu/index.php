...
<!--               <a href="javascript:;" class="collapse"></a>
          ...
          <div class="portlet-body">
            <div id="sample_1_wrapper" class="dataTables_wrapper form-inline" role="grid">
              <div class="row-fluid">
                <div class="span6">
                  <form action="/admin/jichu/index" style="margin:0" >
                    ...
                    foreach($list as $user){
                      ...
                      <tr class="odd gradeX">
                        ...
                        <td>
                          ...
                          <?php //}?>
                          <!-- <a href="/admin/jichu/delete/id/<?php //echo $user->id;?>" onclick="javascript:return confirm('删除主贴所有回复都会删除，确实要删除吗?');">删除</a> -->
                          <a href="/admin/jichu/edit/id/<?php echo $user->id;?>">修改</a>
                          <a href="/admin/jichu/delete/id/<?php echo $user->id;?>" onclick="javascript:return confirm('确实要删除吗?');">删除</a>
