      ...
      <div class="span12">
        ...
        <div class="portlet box light-grey">
          <div class="portlet-title">
            ...
            <div class="caption"><i class="icon-globe"></i>合同列表</div>
            <div class="tools">
<!--               <a href="javascript:;" class="collapse"></a>
          ...
          <div class="portlet-body">
            <div id="sample_1_wrapper" class="dataTables_wrapper form-inline" role="grid">
              <div class="row-fluid">
                <div class="span6">
                  <form action="/admin/purchase/index" style="margin:0" >
                  ...
                  if($list){
                    ...
                    foreach($list as $user){
                      ...
                      <tr class="odd gradeX">
                        ...
                        <td class="hidden-480"><?php echo CHtml::encode($user->owner); ?></td>
                        ...
                        <td>
                          ...
                          <a href="/admin/purchase/show/id/<?php echo $user->id;?>">详细</a>
                          <a href="/admin/purchase/edit/id/<?php echo $user->id;?>">修改</a>
                          <a href="/admin/purchase/delete/id/<?php echo $user->id;?>" onclick="javascript:return confirm('确实要删除吗?');">删除</a>
