                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form action="/admin/payable/saveaddrecieve" id="form_add"  method="post"  class="form-horizontal js-submit">
                                    ...
                                    <div class="control-group" style="margin-top:30px;">
                                        <label class="control-label">收款日<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text" id="datepicker0" value="" name="pay_date" required/>
                                        </div>
                                    </div>   
                                    <div class="control-group">
                                        <label class="control-label">收款周期<span class="required">*</span></label>
                                            <div class="controls" >
                                            <input type="text" id="datepicker1" value="" name="start_time" required/>至<input type="text" id="datepicker2" value="" name="end_time" required/>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="amount" type="text" class="span2 m-wrap" value="" required/>元
                                        </div>
                                    </div> 
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <label class="control-label">
                                                <input name="invoice" type="radio"  value="0"/>否
                                            </label>
                                        </div>
                                    </div>                                                                       
