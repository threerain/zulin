                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form action="/admin/payable/saverecieve" id="form_edit"  method="post"  class="form-horizontal js-submit">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">是否需要发票<span class="required">*</span></label>
                                        <div class="controls">
