              ...
              <div class="row-fluid">
                ...
                <div class="span6">
                  <div class="btn-group pull-right">
                    <?php if(AdminPositionModul::has_modul("501_11")) {?>
                      <a href="/admin/property/splitadd/id/<?php echo $property_id?>">
                        <button id="sample_editable_1" class="btn blue">
                    ...
                    foreach($list as $user){
                      ...
                      <tr class="odd gradeX">
                        ...
                        <td>
                          ...
                          <?php if(AdminPositionModul::has_modul("501_10")) {?>
                            <a href="/admin/property/splitedit/id/<?php echo $user->id;?>">修改</a>
                          <?php }?>
                          <?php if(AdminPositionModul::has_modul("501_12")) {?>
                            <a href="/admin/property/delete/id/<?php echo $user->id;?>" onclick="javascript:return confirm('确实要删除吗?');">删除</a>
                          <?php }?>
