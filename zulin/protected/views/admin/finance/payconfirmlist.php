      ...
      <div class="span12">
        ...
        <div class="portlet box light-grey">
          <div class="portlet-title">
            ...
            <div class="caption"><i class="icon-globe"></i>收房合同已付列表</div>
            <div class="tools">
            </div>
          </div>
                  ...
                  if($list){
                    ...
                    foreach($list as $model){
                      ...
                      <tr class="odd gradeX">
                        ...
                        <!-- <td>
                          <a href="/admin/purchasecontract/payment/id/<?php //echo $model->id;?>">编辑</a>
                          <a href="/admin/purchasecontract/paymentlist/id/<?php //echo $model->id;?>">删除</a>  
                        </td> -->
