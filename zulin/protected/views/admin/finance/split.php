                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form action="/admin/finance/SplitSave" id="form_edit"  method="post"  class="form-horizontal js-submit">
                                    ...
                                    <div class="control-group" style="margin-top:30px;">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="datepicker0" value="<?php echo date('Y-m-d',$model->payment_date ) ?>" name="payment_date" required/>
                                        </div>
                                    </div>   
