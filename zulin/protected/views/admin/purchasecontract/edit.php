<style>
    ...
    #a,#b,#c,#d,#e,#f,#g,#h,#l,#j{height:30px!important;margin-top:-24px;margin-left:-5px;}
    ...
    <div class="caption"><i class="icon-reorder"></i>收房合同-编辑</div>
...
s    </div>
    ...
    <div class="yj-xg-btn" style="margin:30px auto;">
        ...
        <?php foreach ($property as $key => $value): ?>
         <div id="propertys">
                ...
                <div class="control-group"  style="float:left">
                    ...
                    <div class="controls">
                        <input name="property_card[]"   type="text" placeholder="" value="<?php echo CmsPurchaseProperty::model()->find("contract_id = '$contract_id' and property_id = '$value[property_id]' ")->property_card?>" style="width:250px!important" class="span80 m-wrap"/>
                    </div>
                </div>
                <div class="control-group"  style="float:left">
                    <label class="control-label">车源地址<span class="required">*</span></label>
                    <div class="controls">
                        <input name="property_address[]"  value="<?php echo CmsPurchaseProperty::model()->find("contract_id = '$contract_id' and property_id = '$value[property_id]' ")->property_address?>"  type="text" placeholder="" style="width:250px!important" class="span80 m-wrap"/>
                    </div>
                </div>
                <script>
                    $(function(){
                ...
                ?>
                    ...
                    <!-- <div class="control-group" style="margin-left:196px;clear:both;margin-top:80px;">
                        ...
                        <label class="control-labela label2" style="text-align:left;">
                            <input name="house_property_card_text[]" placeholder="详细地址" value="<?php echo $value?>" type="text" style="width:500px;" class="span12 m-wrap"/>

                        </label>
                        <?php
                            if($key==0){
                        ?>
                            <input type="button" value="添加" style="width:60px;" class="span1 m-wrap  " id="h_text">
                        <?php
                                }else{
                        ?>
                        <input type='button' value='删除' style='width:60px;' class='span1 m-wrap h_text_del' >
                        </p>
                        <?php
                                }
                            }
                        ...
                        <script>
                            $(function(){
                                ...
                                $("#h_text").click(function(){
                                    var html1=$("<label  class='control-labela' style='margin-left:47px;clear:both;margin-top:10px;'>"+"<input name='house_property_card_text[]' placeholder='详细地址' type='text' style='width:500px' class='span12 m-wrap'/>"+"<input type='button' value='删除' style='width:60px;' class='span1 m-wrap h_text_del' >"+"</label>")
                    ...
                    <div class="control-group" style="clear:both;margin-top:40px;">
                        ...
                        <div class="controls">
                            <label class="control-labela" style="text-align: left;">
                                ...
                                <input type="button" class="btn red" value="编辑图片" id="h">
      ...
      <div class="yj-xg-xbox"  style="display:none">
                    <div class="xxk-lp-1">
                        <p style="font-size:20px;margin:30px 50px;font-weight:bold;margin-left: 18px;">编辑租期信息</p>
                        ...
                        ?> <div id="free_clone">
                                <div class="control-group inputcss">
                                    <label class="control-label">免租期<span class="required">*</span></label>
                                    <div class="controls">
                                        <input name="free_lease_start[]" type="text" style="width:171px" class="span3 m-wrap date-picker" value="" required/>至<input style="width:171px" name="free_lease_end[]" type="text"class="span3 m-wrap date-picker" value="" required/>
                                        <input name="add_free" type="button" class="span1 m-wrap add_free" style="width:60px;  <?php echo $key>0?'display:none;':'' ?>" value="添加"/>
                                        <input name="del_free" type="button" class="span1 m-wrap del_free" style="width:60px;<?php echo $key==0?'display:none;':'' ?>" value="删除"/>
                                    </div>
                                </div>
                        ...
                        <div id="lease_term_list">
                            ...
                            ?>
                                ...
                                <div class="controls">
                                    ...
                                    月租金<span class="required" style="color:red;" >*</span><input name="sub_monthly_rent[]" type="text"  class="span1 m-wrap" value="<?php echo $value->monthly_rent?$value->monthly_rent/100:""?>" required/>(元)
    ...
    <p style="font-size:20px;margin-top:30px;margin-bottom:30px;font-weight:bold;margin-left: 18px;">编辑付款信息</p>
                    ...
                    <div class="control-group inputcss" style="float:left;clear:both;width:350px;">
                        ...
                        <div class="controls">
                           <input type="text" name="advance_days" style="width:157px;" value="<?php echo $model==null?"":$model->advance_days;?>" required>
                        </div>
                    </div>
                    <div class="control-group inputcss" style="float:left;width:350px;">
                        ...
                        <div class="controls">
                            <input type="text" name="deposit" style="width:100px;" value="<?php echo $model==null?"":$model->deposit/100;?>" required>(元)
                        </div>
                    </div>
                    <div class="control-group inputcss" style="float:left;width:350px;">
    ...
    <div class="controls">
        <input type="hidden" name="salesman_id" value="<?php echo $model==null?"":$model->salesman_id;?>" id="salesman_id" class="span6 select2" style="width:200px;">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="status" <?php if($model->status!=0&&$model->status!=9&&$model->status!=-1){echo 'disabled';} ?> >
                            ...
                            <?php $arr = explode(',',$model->channel_manager_id) ;
                                ...
                                ?>
                                    <div class="control-group" style="clear:both;float:left">
                                        ...
                                        <div class="controls">
                                            <input type="hidden" name="channel_manager_id[]" data="" id="channel_manager_id<?php echo $key ?>" class="span6 select2" style="width:230px" value="<?php echo $value ?>" title="">
                                        </div>
                                    </div>
                                    <script>
                                    $(function(){
...
swf_house_delivery_order_photo = new SWFUpload(settings_house_delivery_order_photo);
    ...
    '                            月租金<input name="sub_monthly_rent[]" type="text" required class="span1 m-wrap"/>'+
