                        ...
                        <div class="control-group" style="margin-top:60px;">
                            ...
                            <div class="controls">
                                <label class="control-labela" style="text-align: left;float:left;margin-right:15px;cursor:pointer;">
                                    <input type="hidden" name="contract_copy" value="<?php $a =  ','.implode(',',$arr);echo $arr?$a:'' ?>"/>
                                    <span id="PlaceHolder_contract_copy"></span>
                                </label>
                                <label class="control-labela label2" style="float:left;100%;">
                                    <input type="button" class="del btn btn-primary " value="编辑图片" id="b">
                                </label>
                            </div>
                            <div class="control-group" style="margin:0;clear:both;">
                                <div class="controls">
                                    ...
                                    <div id="contract_copy_div" style="float:left;100%;height:200px;<?php echo $contract_copy==null?'display: none':''; ?>">
                                        ...
                                        <?php if ($contract_copy):?>
                                            ...
                                            <a target="_Blank" href="<?php echo $value->url; ?>">
                                                <img name="contract_copy_show" src="<?php echo $value->url; ?>" style='max-width:100px;max-height:100px;float:left;margin-left:10px'/>
                                            </a>
        ...
        $(function(){
            $('.del').on('click',function(){
                ...
                $('.del_photo').click(function(){
                    ...
                    var dataStr = $(this).parent().parent().parent().prev().find("input[name='contract_copy']").val();
