                    ...
                    <div class="span12">
                        ...
                        <div class="portlet box blue">
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form action="/admin/purchasecontract/secondtalk_add" id="form_sample_2"  method="post"  class="form-horizontal js-submit">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="datepicker2" value="" class="m-wrap" name="talk_time" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">跟进人<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text"  value="" class="m-wrap" name="follower" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <label class="radio">
                                                <input type="radio" name="result" value="m" />
                                                成功
                                            </label>
                                            <label class="radio">
                                                <input type="radio" name="result" value="f" />
                                                待优化
                                            </label>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text"  value="" class="m-wrap" name="target" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">联系方式<span class="required">*</span></label>
                                        <div class="controls">
                                            <input type="text"  value="" class="m-wrap" name="phone" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">总结<span class="required">*</span></label>
                                        <div class="controls">
                                                                                <!-- 加载编辑器的容器 -->
