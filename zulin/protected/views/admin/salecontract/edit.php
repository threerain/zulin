...
<div class="page-content">
            ...
            <div class="span12">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="caption"><i class="icon-reorder"></i>出车合同-编辑</div>
    ...
    <!-- BEGIN FORM-->
	<form action="/admin/salecontract/editsave" id="form_edit"  method="post"  class="form-horizontal js-submit">
    ...
    <div class="yj-xg-btn" style="margin:30px auto;">
        <div><a href="javascript:void(0)">编辑品牌信息</a></div>
        <div><a href="javascript:void(0)">编辑交易人信息</a></div>
        <div><a href="javascript:void(0)">编辑租期信息</a></div>
        <div><a href="javascript:void(0)">编辑签约信息</a></div>
    </div>
...
<!--            </div>-->
        ...
        <br>
            ...
            <div style="text-align: center;margin-top:100px;margin-bottom:13px;margin-left:100px;">
      ...
      <div class="yj-xg-xbox"  style="display:none">
		<div class="xxk-lp-1">
			<div class="control-group">
                ...
                <div class="controls">
                    <label class="radio">
                        <input type="radio" name="lessor2" value="幼狮" <?php echo $model==null?"":$model->lessor=="幼狮"?"checked":""; ?>/>
                        幼狮
                    </label>
                    <label class="radio">
                        <input type="radio" name="lessor2" value="其它" <?php echo $model==null?"":$model->lessor!="幼狮"?"checked":""; ?>/>
                        其它
                    </label>
						...
						<div id="client_id_card_photo_div" style="float:left;100%;height:200px;<?php echo $client_id_card_photo==null?'display:none':''; ?>;">
                            <?php if ($client_id_card_photo): ?>
                                <?php foreach ($client_id_card_photo as $key => $value): ?>
                                    <a target="_Blank" href="<?php echo $value; ?>"><img name="client_id_card_photo_show" src="<?php echo $value ?>" style='max-width:100px;max-height:100px;float:left;margin-left:10px'/></a><img style="float:left;display:none;"  class="del_photo" src="/css/image/delete.jpg" width="25px" alt="" />
                                <?php endforeach ?>
                            <?php endif ?>
                ...
                <div id="free_clone">
                    ...
                    <div class="free-box"></div>  
                        ...
                        <div id="lease_term_list">
							...
							?>
								...
								<div class="controls">
									...
									月租金<span class="required">*</span><input name="sub_monthly_rent[]" type="text" placeholder="单位元" class="span1 m-wrap" value="<?php echo $value->monthly_rent?$value->monthly_rent/100:""?>" required/>(元)
                        ...
                        <div class="control-group inputcss" style="float:left;width:350px;">
                            ...
                            <div class="controls">
                                <input type="text" name="deposit_memo"  value="<?php echo $model==null?"":$model->deposit_memo;?>">
                            </div>
                        </div>
                        <div class="control-group inputcss" style="float:left;clear:both;width:350px;">
  ...
  <div class="controls">
      <input type="hidden" name="salesman_id" value="<?php echo $model==null?"":$model->salesman_id;?>" id="salesman_id" class="span6 select2" style="width:200px;">
                        ...
                        <div class="control-group" style="float:left;">
                            ...
                            <div class="controls">
                                <select <?php if($model->status!=0&&$model->status!=9&&$model->status!=-1){echo 'disabled';} ?> name="status" style="width:200px;">
                ...
                <div class="controls">
                    ...
                    <div class="yj-qy-xx">
                            ...
                            <?php if ($model->break_contract): ?>
                                <div class="control-group" id="break_contract" style="display:none;float:left;">
                                    <label class="control-label" >违约原因</label>
                                    <div class="controls">
                                        <select disabled name="break_contract" style="width:200px;">
                                            <option value="1" <?php echo $model->break_contract==1?'selected':'' ?>>提前退租</option>
                                            <option value="2"<?php echo $model->break_contract==2?'selected':'' ?>>申请换租->扩租</option>
                                            <option value="3"<?php echo $model->break_contract==3?'selected':'' ?>>申请换租->缩租</option>
                                            <option value="4"<?php echo $model->break_contract==4?'selected':'' ?>>申请换租->同租</option>
                                            <option value="5"<?php echo $model->break_contract==5?'selected':'' ?>>转租</option>
                                            <option value="6"<?php echo $model->break_contract==6?'selected':'' ?>>其他</option>
                                        </select>
                                    </div>
                                </div>
                            <?php else: ?>
                            ...
                            <?php if ($model->break_contract_text): ?>
                                <div class="control-group" id="break_contract_text" style="display:none;float:left;">
                                    <label class="control-label">其他原因</label>
                                    <div class="controls">
                                        <input disabled> name="break_contract_text"  type="text" value="<?php echo $model->break_contract_text; ?>" />
                                    </div>
                                </div>
                            <?php else: ?>
                                <div class="control-group" id="break_contract_text" style="display:none;float:left;">
...
//alert(e.date.valueOf()-startDate);
            ...
            for (var i = 0; i < count; i++) {
                var html='<div class="control-group inputcss">'+
                    ...
                    '                            月租金<span class="required" style="color:red;">*</span><input name="sub_monthly_rent[]" type="text"  class="span1 m-wrap"/>(元)'+
