<style>
    ...
    #b{height:35px!important;margin-top:-5px;margin-left:-5px;}
...
<div class="page-content">
            ...
            <div class="span12">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="caption"><i class="icon-reorder"></i>出车合同-审核</div>
    ...
    <!-- BEGIN FORM-->
	<form action="/admin/salecontract/ReviewedSave" id="form_edit"  method="post"  class="form-horizontal js-submit">
      ...
      <div class="yj-xg-xbox"  style="display:none">
		<div class="xxk-lp-1">
			<div class="control-group">
				<label class="control-label">出&nbsp;租&nbsp;人<span class="required">*</span></label>
                <div class="controls">
                    <label class="radio">
                        <input type="radio" name="lessor2" value="华溯商贸" <?php echo $model==null?"":$model->lessor=="华溯商贸"?"checked":""; ?>/>
                        华溯商贸
                    </label>
                    <label class="radio">
                        <input type="radio" name="lessor2" value="幼狮科技" <?php echo $model==null?"":$model->lessor=="幼狮科技"?"checked":""; ?>/>
                        幼狮科技
                    </label>
                    <label class="radio">
                        <input type="radio" name="lessor2" value="其它" <?php echo $model==null?"":$model->lessor!="幼狮科技"&&$model->lessor!="华溯商贸"?"checked":""; ?>/>
                        其它
                    </label>
                        <input name="lessor" type="text" style="<?php echo $model==null?"":$model->lessor!="幼狮科技"&&$model->lessor!="华溯商贸"?"":"display:none"; ?>" class="span2 m-wrap" value="<?php echo $model==null?"":$model->lessor; ?>"/>
                </div>
			</div>
<!--             <div class="control-group">
                <label class="control-label">出租人<span class="required">*</span></label>
                <input type="text" value="" name="lessor">
            </div> -->
			<div class="control-group">
				<label class="control-label">承租人类型</label>
				<div class="controls">
					<label class="radio">
						<input type="radio" name="lessee_type" value="1" <?php echo $model==null?"":$model->lessee_type=="1"?"checked":""; ?> />
						公司
					</label>
					<label class="radio">
						<input type="radio" name="lessee_type" value="2" <?php echo $model==null?"":$model->lessee_type=="2"?"checked":""; ?> />
						个人
					</label>
				</div>
			</div>
			...
			<div id="company" style="<?php echo $model->lessee_type==1?"":"display:none;"; ?>">
					...
					<div class="controls">
						...
						<?php if ($business_license_photo):?>
							<?php foreach ($business_license_photo as $key => $value):?>
								<a href="<?php echo $value; ?>"><img name="business_license_photo_show" src="<?php echo $value; ?>" style='max-width:100px;max-height:100px;float:left;margin-left:10px'/></a><img style="float:left;display:none;"  class="del_photo" src="/css/image/delete.jpg" width="25px" alt="" />
							<?php endforeach ?>
				...
				<div class="control-group">
					...
					<div class="controls">
                        ...
                        <label class="control-labela label1">备注</label>
                        <label class="control-labela label2">
                            <input name="corporation_text" type="text" value="<?php echo $model->corporation_text ?>" class="span12 m-wrap" style="width:400px;"/>
					...
					<div class="controls">
						...
						<?php if ($corporation_photo): ?>
							<?php foreach ($corporation_photo as $key => $value): ?>
								...
								<a href="<?php echo $value; ?>"><img name="corporation_photo_show" src="<?php echo $value ?>" style='max-width:100px;max-height:100px;float:left;margin-left:10px'/></a><img style="float:left;display:none;"  class="del_photo" src="/css/image/delete.jpg" width="25px" alt="" />
							<?php endforeach ?>
			...
			<div id="personal" style="<?php echo $model->lessee_type==2?"":"display:none;"; ?>">
				...
				<div class="control-group" style="clear:both;margin-top:40px;">
					...
					<div class="controls">
						<label class="control-labela" style="text-align: left;">
							<input type="checkbox" name="client_id_card" <?php echo $model->client_id_card==1?"checked":""; ?>/>
							<input type="hidden" name="client_id_card_photo" value="<?php $a =  ','.implode(',',$client_id_card_photo);echo $client_id_card_photo?$a:'' ?>" />
						...
						<div id="client_id_card_photo_div" style="float:left;100%;height:200px;<?php echo $client_id_card_photo==null?'display:none':''; ?>;">
                            <?php if ($client_id_card_photo): ?>
                                <?php foreach ($client_id_card_photo as $key => $value): ?>
                                    <a href="<?php echo $value; ?>"><img name="client_id_card_photo_show" src="<?php echo $value ?>" style='max-width:100px;max-height:100px;float:left;margin-left:10px'/></a><img style="float:left;display:none;"  class="del_photo" src="/css/image/delete.jpg" width="25px" alt="" />
                                <?php endforeach ?>
                            <?php endif ?>
			...
			<div class="control-group" style="clear:both;margin-top:40px;">
				...
				<div class="controls">
                    ...
                    <label class="control-labela label1">备注</label>
                    <label class="control-labela label2">
                        <input name="accredited_representative_text" type="text" value="<?php echo $model->accredited_representative_text ?>" class="span12 m-wrap" style="width:400px;"/>
					...
					<div id="accredited_representative_photo_div" style="float:left;100%;height:200px;<?php echo $accredited_representative_photo==null?'display:none':''; ?>">
						<?php if ($accredited_representative_photo): ?>
							<?php foreach ($accredited_representative_photo as $key => $value): ?>
								<a href="<?php echo $value; ?>"><img name="accredited_representative_photo_show" src="<?php echo $value ?>" style='max-width:100px;max-height:100px;float:left;margin-left:10px'/></a><img style="float:left;display:none;"  class="del_photo" src="/css/image/delete.jpg" width="25px" alt="" />
							<?php endforeach ?>
						<?php endif ?>
					</div>
				</div>
			...
			<div class="control-group" style="clear:both;margin-top:40px;">
				...
				<div class="controls">
                    ...
                    <label class="control-labela label1">备注</label>
                    <label class="control-labela label2">
                        <input name="authorized_id_card_text" type="text" value="<?php echo $model->authorized_id_card_text ?>" class="span12 m-wrap" style="width:400px;"/>
					...
					<div id="authorized_id_card_photo_div" style="float:left;100%;height:200px;<?php echo $authorized_id_card_photo==null?'display:none':''; ?>">
						<?php if ($authorized_id_card_photo): ?>
							<?php foreach ($authorized_id_card_photo as $key => $value): ?>
								<a href="<?php echo $value; ?>"><img name="authorized_id_card_photo_show" src="<?php echo $value ?>" style='max-width:100px;max-height:100px;float:left;margin-left:10px'/></a><img style="float:left;display:none;"  class="del_photo" src="/css/image/delete.jpg" width="25px" alt="" />
							<?php endforeach ?>
						<?php endif ?>
					</div>
				</div>
			...
			<div class="control-group" style="clear:both;margin-top:40px;">
				...
				<div class="controls">
                    ...
                    <label class="control-labela label1">备注</label>
                    <label class="control-labela label2">
                        <input name="house_delivery_order_text" type="text" value="<?php echo $model->house_delivery_order_text ?>" class="span12 m-wrap" style="width:400px;"/>
					...
					<div id="house_delivery_order_photo_div" style="float:left;100%;height:200px;<?php echo $house_delivery_order_photo==null?'display:none':''; ?>">
						<?php if ($house_delivery_order_photo): ?>
							<?php foreach ($house_delivery_order_photo as $key => $value): ?>
								<a href="<?php echo $value; ?>"><img name="house_delivery_order_photo_show" src="<?php echo $value ?>" style='max-width:100px;max-height:100px;float:left;margin-left:10px'/></a><img style="float:left;display:none;"  class="del_photo" src="/css/image/delete.jpg" width="25px" alt="" />
							<?php endforeach ?>
						<?php endif ?>
					</div>
				</div>
      ...
      <div class="yj-xg-xbox"  style="display:none">
                    <div class="xxk-lp-1">
                        ...
                        ?>
                            <div id="free_clone">
                                <div class="control-group inputcss">
                                    ...
                                    <div class="controls">
                                        <input name="free_lease_start[]" type="text" style="width:171px" class="span3 m-wrap date-picker" value="<?php echo $value->start_time?date('Y-m-d',$value->start_time):"";?>"/>至<input style="width:171px" name="free_lease_end[]" type="text"class="span3 m-wrap date-picker" value="<?php echo $value->end_time?date('Y-m-d',$value->end_time):"";?>"/>
                        ...
                        <div class="control-group inputcss">
                            <label class="control-label">免租期</label>
                            <div class="controls">
                                <input name="free_lease_start[]" type="text" style="width:171px" class="span3 m-wrap date-picker"/>至<input name="free_lease_end[]" type="text" style="width:171px" class="span3 m-wrap date-picker"/>
                    ...
                    <div class="free-box"></div>  
                        ...
                        <div class="control-group inputcss">
                            ...
                            <div class="controls">
                                <input name="lease_term_start" class="m-wrap m-ctrl-medium date-picker" size="16" type="text" value="<?php echo $model->lease_term_start?date('Y-m-d',$model->lease_term_start):""?>" />至<input id="lease_term_end" name="lease_term_end" class="m-wrap m-ctrl-medium date-picker" size="16" type="text" value="<?php echo $model->lease_term_end?date('Y-m-d',$model->lease_term_end):""?>" />
                        ...
                        <div id="lease_term_list">
							...
							?>
								...
								<div class="controls">
									<input name="term_start[]" class="m-wrap m-ctrl-medium date-picker span2"  size="16" type="text" value="<?php echo $value->start_time?date('Y-m-d',$value->start_time):"";?>" required="required" />至<span class="required" ></span>
									<input name="term_end[]" class="m-wrap m-ctrl-medium date-picker span2"  size="16" type="text" value="<?php echo $value->end_time?date('Y-m-d',$value->end_time):"";?>" required="required" />
									月租金<input name="sub_monthly_rent[]" type="text" placeholder="单位元" class="span1 m-wrap" value="<?php echo $value->monthly_rent?$value->monthly_rent/100:""?>"/>(元)
									单价<input name="sub_price_per_meter[]" type="text" placeholder="单位元/天/㎡" class="span1 m-wrap" value="<?php echo $value->price_per_meter?$value->price_per_meter/100:""?>"/>(元/天/㎡)
                        ...
                        <div id="pay_clone">
                            <div class="control-group inputcss" style="float:left;clear:both;">
                                ...
                                <div class="controls">
                                    <input type="text" name="deposit_month[]" style="width:25px" value="<?php echo $value->deposit_month;?>">
                                </div>
                            </div>
                            <div class="control-group inputcss" style="float:left;margin-left:0px;">
                                ...
                                <div class="controls">
                                    <input type="text"  name="pay_month[]" style="width:25px" value="<?php echo $value->pay_month;?>">
                                </div>
                            </div>
                            <div class="control-group inputcss" style="float:left;">
                                <label class="control-label">日期区间<span class="required">*</span></label>
                                <div class="controls">
                                    <input name="deposit_start_time[]" type="text" class="span3 m-wrap date-picker"/ style="width:171px" value="<?php echo $value->start_time?date('Y-m-d',$value->start_time):''?>" >至<input name="deposit_end_time[]" type="text" style="width:171px" class="span3 m-wrap date-picker" value="<?php echo $value->end_time?date('Y-m-d',$value->end_time):''?>"/>
                        ...
                        <div id="pay_clone">
                            <div class="control-group inputcss" style="float:left;clear:both;">
                                <label class="control-label">押<span class="required">*</span></label>
                                <div class="controls">
                                    <input type="text" name="deposit_month[]" style="width:25px" value="">
                                </div>
                            </div>
                            <div class="control-group inputcss" style="float:left;margin-left:0px;">
                                <label class="control-label">付<span class="required">*</span></label>
                                <div class="controls">
                                    <input type="text"  name="pay_month[]" style="width:25px" value="">
                                </div>
                            </div>
                            <div class="control-group inputcss" style="float:left;">
                                <label class="control-label">日期区间<span class="required">*</span></label>
                        ...
                        <div class="control-group inputcss" style="float:left;clear:both;">
                            ...
                            <div class="controls">
                                <input name="deposit_pay_time" type="text" class="span3 m-wrap date-picker"/ style="width:171px" value="<?php echo $model->deposit_pay_time?date('Y-m-d',$model->deposit_pay_time):''?>" >
                            </div>
                        </div>
                        <div class="control-group inputcss" style="float:left;">
                            <label class="control-label">首期租金付款日期<span class="required">*</span></label>
                            <div class="controls">
                                <input name="rent_start_time" type="text" class="span3 m-wrap date-picker"/ style="width:171px" value="<?php echo $model->rent_start_time?date('Y-m-d',$model->rent_start_time):''?>" >
                            </div>
                        </div>
                        <div class="control-group inputcss" style="float:left;">
                            <label class="control-label">二期租金付款日期<span class="required">*</span></label>
                            <div class="controls">
                                <input name="rent_second_time" type="text" class="span3 m-wrap date-picker"/ style="width:171px" value="<?php echo $model->rent_second_time?date('Y-m-d',$model->rent_second_time):''?>" >
                            </div>
                        </div>
                        <div style="">
  ...
  <div class="controls">
      <input type="hidden" name="salesman_id" value="<?php echo $model==null?"":$model->salesman_id;?>" id="salesman_id" class="span6 select2" style="width:200px;">
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                                <input name="signing_date" value="<?php echo $model->signing_date?date('Y-m-d',$model->signing_date):""?>" class="m-wrap m-ctrl-medium date-picker"  size="16" type="text" / style="width:155px;">
                            </div>
                          </div>
            <div class="control-group" style="float:left">
            ...
            <div class="control-group" style="float:left">
                ...
                <div class="controls">
                    <input type="hidden" name="channel_manager_id" id="channel_manager_id" class="span6 select2" style="width:230px" value="<?php echo $model->channel_manager_id ?>" title="">
                </div>
            </div>
                          <br>
                          <br>
                    ...
                    <div class="yj-qy-xx">
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    <input name="the_date" class="m-wrap m-ctrl-medium date-picker"  size="16" type="text" value="<?php echo $model->the_date?date('Y-m-d',$model->the_date):""?>" />
                                </div>
                            </div>
                           <div class="control-group">
                 ...
                 <div style="text-align: center;margin-top:100px;margin-bottom:13px;">
                    <button  type="submit" class="btn btn-primary submit js-btnadd">审核</button>
