...
<!--               <a href="javascript:;" class="collapse"></a>
          ...
          <div class="portlet-body">
            <div id="sample_1_wrapper" class="dataTables_wrapper form-inline" role="grid">
              <div class="row-fluid">
                <div class="span6">
                  <form action="/admin/pushed/index" style="margin:0" >
                  ...
                  if($list){
                    ...
                    foreach($list as $user){
                      ...
                      <tr class="odd gradeX">
                        ...
                        <td class="center hidden-480"><img style="width:50px;height:50px;" src="<?php echo $user->avatar; ?>"> </td>
                        <td class="center hidden-480"><?php echo date('Y-m-d H:i:s', $user->last_login_time); ?></td>
                        <td>
                          ...
                          <?php //}?>
                          <!-- <a href="/admin/pushed/delete/id/<?php //echo $user->id;?>" onclick="javascript:return confirm('删除主贴所有回复都会删除，确实要删除吗?');">删除</a> -->
                          <a href="/admin/pushed/edit/id/<?php echo $user->id;?>">修改</a>
                          <a href="/admin/pushed/delete/id/<?php echo $user->id;?>" onclick="javascript:return confirm('确实要删除吗?');">删除</a>
