...
<!-- 
                            ...
                            <div class="portlet-body form">
                                ...
                                <!-- BEGIN FORM-->
                                <form action="/admin/pushed/editsave" id="form_sample_3"  method="post"  class="form-horizontal js-submit">
...
<!--                                     <div class="control-group">
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">   
											<input type="text" class="span6" disabled="" placeholder="<?php echo $model==null?"":$model->account;?>" class="m-wrap medium">
										</div>
									</div>
                                     <div class="control-group">
                                        <label class="control-label">密码</label>
                                        <div class="controls">
                                            <input name="password" type="password" class="span6 m-wrap" value="<?php echo $model==null?"":$model->nickname;?>"/>
                                        </div>
                                    </div>
                                    <!-- <div class="control-group">
