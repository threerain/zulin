 ...
 */
class CmsPurchasePayable extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('the_order, start_time, end_time, amount, type, deleted, ctime', 'numerical', 'integerOnly'=>true),
			array('id, contract_id', 'length', 'max'=>36),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, contract_id, the_order, start_time, end_time, amount, type, deleted, ctime', 'safe', 'on'=>'search'),
		);
	}
