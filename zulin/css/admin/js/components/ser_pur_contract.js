    ...
    var handleSelectHouseNo = function () {
        ...
        function movieFormatSelection(movie) {
            ...
            $.ajax("/admin/property/ajaxlistbyid", {
                ...
                $.post('/admin/serpurcontract/ajaxroom',{room_number:data.property_id},function(data){
                    //多编号显示
                    $(".house_no").html("")
                    var a = $(".house_no").html();
